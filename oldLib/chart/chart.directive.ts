...
// This directive is based on ng2-charts package and requires chart.js package to works
...
export class BaseChartDirective implements OnDestroy, OnChanges, OnInit {
    ...
    public getChartBuilder(ctx: any/*, data:Array<any>, options:any*/): any {
        ...
        const options: any = (<any>Object).assign({}, this.options);
        ...
        if (this.datasets && this.datasets.length ||
            ...
            datasets = (this.datasets || datasets)
                .map((elm: number, index: number) => {
                    const newElm: any = (<any>Object).assign({}, elm);
                    if (this.colors && this.colors.length) {
                        (<any>Object).assign(newElm, this.colors[index]);
                    } else {
                        (<any>Object).assign(newElm, getColors(this.chartType, index, newElm.data.length));
                    }
                    return newElm;
                });
        }
    ...
    private refresh(): any {
        ...
        // remove this line, it is producing flickering
        this.ngOnDestroy();
 ...
 */
function generateColor(index: number): any {
