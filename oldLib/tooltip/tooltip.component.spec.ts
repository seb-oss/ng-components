...
describe("Component: TooltipComponent", () => {
    ...
    it("should be able to call click event onClick when clickAction is provided ", async(() => {
        ...
        fixture.debugElement.query(By.css(".my-tooltip > .icon")).triggerEventHandler("click", { e: event });
    ...
    it("should render the content html", async(() => {
        ...
        const messageContainer = htmlFixture.debugElement.query(By.css(".content .message-container")).nativeElement;
