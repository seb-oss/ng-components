...
describe("Component: LoaderComponent", () => {
    ...
    it("should only render when toggle is true", async(() => {
        ...
        component.className = "test-loader";
        fixture.detectChanges();
        expect(fixture.debugElement.query(By.css(".seb-loader"))).toBeFalsy();
        component.toggle = true;
        fixture.detectChanges();
        expect(fixture.debugElement.query(By.css(".seb-loader"))).toBeTruthy();
    }));
    ...
    it("should be able to set sizes by sizeClass or size parameter", async(() => {
        component.toggle = true;
        component.fullScreen = false;
        component.sizeClassName = "loader-sm";
        fixture.detectChanges();
        expect(fixture.debugElement.query(By.css(".seb-loader.loader-sm"))).toBeTruthy();
        component.sizeClassName = null;
        component.size = "large";
        fixture.detectChanges();
        expect(fixture.debugElement.query(By.css(".seb-loader.loader-lg"))).toBeTruthy();
    }));
});
