...
export class ExampleListComponent implements OnInit {
    ...
    constructor(private route: ActivatedRoute, private exampleService: ExampleService, private exampleQuery: ExampleQuery) {}
    ...
    ngOnInit() {
      ...
      map(data => Object.keys(data).map( key => data[key]))
        ...
        this.$showOutlet = this.exampleQuery.$isFullscreen.pipe(share());
