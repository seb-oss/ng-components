...
@Component({
    selector: "app-textboxGroup",
    templateUrl: "./textboxGroup.component.html",
})
export class TextboxGroupComponent {
    private _textBoxGroupValue: string = "";
    private _textBoxGroupValue2: string = "";
    private _textBoxGroupValue3: string = "";
    private _textBoxGroupValue4: string = "";
