...
@Component({
    ...
    template: `
        <div class="container">
            ...
            <app-code-snippet [languages]="['properties']">npm install @sebgroup/ng-components</app-code-snippet>
            ...
            <app-code-snippet [languages]="['properties']">npm install @sebgroup/bootstrap</app-code-snippet>
